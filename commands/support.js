...
module.exports.run = async (client, message, msg, args) => {
  ...
  let something = new Discord.RichEmbed()
    ...
    .setAuthor("❕Serwer Wsparcia❕")
    .setTitle("")
    .setDescription("Jeśli znalazłeś błąd lub masz jakiś inny problem, zgłoś go na serwerze.")
    .addField("Zaproszenie", "https://discord.gg/BhWTBTb")
