...
module.exports.run = async (client, message, msg, args) => {
  ...
  let something = new Discord.RichEmbed()
    ...
    .setTitle("")
    .setDescription("Link do dodania bota na serwer.")
    .addField("Link", "https://discord.com/api/oauth2/authorize?client_id=751512969036169266&permissions=8&scope=bot")
