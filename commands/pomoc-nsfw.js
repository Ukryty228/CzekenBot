...
module.exports.run = async (client, message, msg, args) => {
  ...
  let something = new Discord.RichEmbed()
    ...
    .setAuthor("📛NSFW📛")
    .setTitle("")
    .setDescription("Lista komend nsfw.")
    .addField("**m!gif**", "wysyła losowy gif nsfw")
    .addField("**m!4k**", "wysyła losowe zdjecię typu 4k")
    .addField("**m!ass**", "wysyła losowe zdjęcie typu ass")
    .addField("**m!anal**", "wysyła losowy gif typu anal")
    .addField("**m!pussy**", "wysyła losowe zdjęcie typu pussy")
    .addField("**m!hentai**", "wysyła losowe zdjęcie typu hentai")
