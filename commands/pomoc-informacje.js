...
module.exports.run = async (client, message, msg, args) => {
  ...
  let something = new Discord.RichEmbed()
    ...
    .addField("**m!bot-info**", "wyświetla informacje o bocie")
    .addField ("**m!support**", "wysyła zaproszenie na serwer wsparcia")
    .addField ("**m!invite**", "wysyła link do dodania bota na serwer")
